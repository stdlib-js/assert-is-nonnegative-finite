...
```javascript
import isNonNegativeFinite from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-nonnegative-finite@v0.1.2-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { isObject, isPrimitive } from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-nonnegative-finite@v0.1.2-deno/mod.js';
```
