...
```javascript
isNonNegativeFinite = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-is-nonnegative-finite@v0.1.2-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/assert-is-nonnegative-finite/actions/workflows/test.yml/badge.svg?branch=v0.1.2
[test-url]: https://github.com/stdlib-js/assert-is-nonnegative-finite/actions/workflows/test.yml?query=branch:v0.1.2
